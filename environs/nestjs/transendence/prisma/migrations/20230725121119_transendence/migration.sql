...
-- CreateEnum
CREATE TYPE "services"."role" AS ENUM ('USER', 'OPERATOR');
...
CREATE TABLE "services"."accounts" (
    ...
    "idSubject" VARCHAR(256) NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "accounts_idIssuer_idSubject_key" ON "services"."accounts"("idIssuer", "idSubject");
...
-- CreateIndex
CREATE UNIQUE INDEX "achievements_accountId_key" ON "services"."achievements"("accountId");
...
-- AddForeignKey
ALTER TABLE "services"."accounts" ADD CONSTRAINT "accounts_id_fkey" FOREIGN KEY ("id") REFERENCES "services"."records"("accountId") ON DELETE RESTRICT ON UPDATE CASCADE;
